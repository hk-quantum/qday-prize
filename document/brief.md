...
For details of the Oracle, see [this report](https://github.com/hk-quantum/qday-prize/blob/v2.0.0/document/report.md).
...
For details, see [this report](https://github.com/hk-quantum/qday-prize/blob/v2.0.0/document/report.md).
